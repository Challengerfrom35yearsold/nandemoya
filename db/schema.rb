...
ActiveRecord::Schema.define(version: 2023_07_16_061335) do
  ...
  create_table "customer_inquiry_threads", force: :cascade do |t|
  ...
  create_table "shop_inquiry_threads", force: :cascade do |t|
  ...
  create_table "what_you_wants", force: :cascade do |t|
    t.integer "customer_id", null: false
    t.integer "item_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
